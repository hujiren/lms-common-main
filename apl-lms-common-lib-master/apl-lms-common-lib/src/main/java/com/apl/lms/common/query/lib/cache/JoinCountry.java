...
public class JoinCountry extends JoinBase<CountryCacheBo> {
    ...
    public JoinCountry(int joinStyle, LmsCommonFeign lmsCommonFeign, RedisTemplate redisTemplate) {
    ...
    public Boolean addCache(String keys, Long minKey, Long maxKey){
        ...
        ResultUtils<Boolean> result = lmsCommonFeign.addCountryCacheByCode(keys, minKey, maxKey);
