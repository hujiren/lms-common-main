...
@ApiModel(value="机场 更新对象", description="机场 更新对象")
public class AirPortUpdDto extends Model<AirPortUpdDto> {

    @ApiModelProperty(name = "oldCode" , value = "旧机场简码", required = true)
    @NotEmpty(message = "旧简码不能为空")
